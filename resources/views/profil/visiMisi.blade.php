      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-xl-12 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="card">
                <div class="card-body">
                  <img src="assets/img/Profil/Visi Dan Misi/Pelantikan.jpeg" alt="" class="d-block mx-auto img-fluid">
                  <h3 class="card-title mt-3 ms-5 fw-bold">Visi</h3>
                  <p class="card-text mt-3 ms-5 me-5">Pada tahun 2026 menjadi Asosiasi terkemuka yang bereputasi internasional, memiliki jejaring global, dan memberikan kontribusi signifikan bagi peningkatan kualitas Pendidikan Tinggi Informatika dan Komputer di Indonesia</p>
                  <h3 class="card-title mt-3 ms-5 fw-bold">Misi</h3>
                  <ul class="ms-5">
