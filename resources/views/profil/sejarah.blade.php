      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-xl-12 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="card">
                <div class="card-body">
                  <img src="assets/img/Profil/Sejarah/Foto_Profil.jpeg" alt="" class="d-block mx-auto img-fluid">
                  <p class="card-text mt-3">Semuanya bermula pada tahun 1983, yaitu ketika 8 (delapan) perguruan tinggi penggagas pendirian Program Studi  informatika dan komputer membentuk sebuah forum yang diberi nama <span class="fw-bold">Badan Kerja Sama Perguruan Tinggi Sejenis Ilmu Komputer (BKS PERTINIS I-K).</span> Sejalan dengan perkembangan pesat ilmu komputer dan informatika, anggota BKS PERTINIS I-K bertambah menjadi 78 (Tujuh Puluh Delapan) anggota pada tahun 1987.</p>
                  <p class="card-text mt-3">Puncaknya adalah pada tahun 1996, ketika BKS PERTINIS I-K berubah nama menjadi <span class="fw-bold">Perguruan Tinggi Informatika dan Komputer (PERTIKOM)</span> jumlah anggota menjadi lebih dari 250 Program Studi dari seluruh wilayah tanah air.</p>
                  <p class="card-text mt-3">Sesuai dengan kebutuhan dan perkembangan jaman, maka pada Rapat Koordinasi Nasional (Rakornas) 2002 di kota Malang, diusulkanlah perubahan bentuk organisasi dari PERTIKOM menjadi <span class="fw-bold">Asosiasi Perguruan Tinggi Informatika dan Komputer (APTIKOM).</</span></p>
                  <p class="card-text mt-3">Memperhatikan Perkembangan Ilmu Pengetahuan dan Teknologi, khususnya Ilmu Pengetahuan dan Teknologi Informatika dan Komputer serta memperhatikan hasil rapat Pengurus Pusat Aptikom pada tanggal 04 Januari 2015 di Universitas Indonesia maka pada  acara pelantikan Pengurus Pusat Aptikom periode 2014-2018 pada hari Sabtu 10 Januari 2015 di Jakarta. secara resmi diputuskan untuk mengubah singkatan APTIKOM dari <span class="fw-bold">ASOSIASI PERGURUAN TINGGI INFORMATIKA DAN KOMPUTER menjadi ASOSIASI PENDIDIKAN TINGGI INFORMATIKA DAN KOMPUTER disingkat APTIKOM.</span></p>   
                </div>
              </div>
