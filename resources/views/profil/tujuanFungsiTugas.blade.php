    ...
    <div class="container mt-5 mb-5">
      ...
      <ul class="nav nav-tabs" id="myTab" role="tablist">
          <li class="nav-item" role="presentation">
              <button class="nav-link active" id="tujuan-tab" data-bs-toggle="tab" data-bs-target="#tujuan" type="button" role="tab" aria-controls="tujuan" aria-selected="true">Tujuan</button>
          </li>
          <li class="nav-item" role="presentation">
              <button class="nav-link" id="fungsi-tab" data-bs-toggle="tab" data-bs-target="#fungsi" type="button" role="tab" aria-controls="fungsi" aria-selected="false">Fungsi</button>
          </li>
          <li class="nav-item" role="presentation">
      ...
      <div class="tab-content border border-top-0 p-3" id="myTabContent">
          ...
          <div class="tab-pane fade" id="fungsi" role="tabpanel" aria-labelledby="fungsi-tab">
            <h5>Internal</h5>
            <ol>
            ...
            <h5>Eksternal</h5>
            <ol>
                <li>Mitra dalam pengembangan, pemberdayaan dan pemanfaatan dari informatika dan komputer di lingkungan pemerintah, masyarakat, dan industri.</li>
