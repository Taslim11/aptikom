          ...
          <div class="col-xl-12 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <img src="assets/img/berita/2.jpg" class="card-img-top" alt="Gambar Berita">
              <div class="card-body">
                ...
                <p class="card-text">Yth,</p>
                <p class="card-text">Bpk/Ibu Pimpinan Perguruan Tinggi,</p>    
                <p class="card-text">Sampai bertemu pada RAKORNAS APTIKOM 2024 (24 – 26 Okt 2024), bagi Perguruan Tinggi yang minat melaksanakan PkS/MoU disilahkan untuk isi Form berikut:</p>     
                <p class="card-text">Link:  https://forms.gle/Z6FuvBYbHfCQwW2u6</p>    
                <p class="card-text">Pilihan PkS/MoU:</p> 
                <ol>
                    <li>⁠PkS Perguruan Tinggi dengan APTIKOM</li>
                    <li>⁠MoU Perguruan Tinggi dengan Perguruan Tinggi</li>
                    <li>⁠MoU Perguruan Tinggi dengan Industri </li>
                </ol>  
