      ...
      <div class="container position-relative d-flex align-items-center justify-content-between">
        <a href="{{ url('index')}}" class="logo d-flex align-items-center">
          ...
          <ul>
            ...
            <li class="dropdown"><a href="#" class="active"><span>KEANGGOTAAN</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
              <ul>
      ...
      <div class="container">
        ...
        <div class="row gy-4">
            ...
            <div class="">
                <div class="card-body">
                    <div class=" text-center">
                        <div class="card">
                          <img src="assets/img/sk.png" class="card-img-top img-fluid" alt="Gambar Berita">
                          <div class="card-body">
                            <a href="{{ asset('SK_KEANGGOTAAN_APTIKOM.pdf')}}" class="btn btn-primary">Download</a>
                          </div>
                        </div>
                      </div>
                  <p class="card-text mt-3"><span class="fw-bold">PROSEDUR PENDAFTARAN & PERPANJANGAN KEANGGOTAAN APTIKOM</span></p>
                  <p class="card-text mt-3">Keanggotaan APTIKOM terdiri dari 2 (dua) unsur,  yaitu :</p>
                      <ol>
                        <li>Individu/Perorangan dan</li>
                        <li>Program Studi</li>
                      </ol>
                  <p class="card-text mt-3"><span class="fw-bold">Prosedur pendaftaran INDIVIDU/PERORANGAN :</span></p>
                      <ol>
                        <li>Silahkan lakukan registrasi pada link berikut <span class="fw-bold">https://dias.aptikom.org/individu/pendaftaran</span></li>
                        <li>Setelah proses registrasi, admin akan mengiriman email konfirmasi mengenai kuitansi dan nomor keanggotaan</li>
                        <li>Aggota dapat mengecek kartu keanggotaan melalui link berikut <span class="fw-bold">https://dias.aptikom.org/login-anggota</span>menggunakan nomor anggota dan menginput password</li>                          
                        <li>Kartu anggota dapat di download di halaman utama</li>
                        <li>Jika sudah selesai, anggota dapat melakukan pengecekan keanggotaan individu pada link berikut <span class="fw-bold">https://dias.aptikom.org/list-anggota.</span></li>
                      </ol>
                  <p class="card-text mt-3"><span class="fw-bold">Prosedur perpanjangan INDIVIDU/PERORANGAN :</span></p>
                      <ol>
                        <li>Silahkan lakukan registrasi pada link berikut <span class="fw-bold">https://dias.aptikom.org/individu/perpanjangan</span></li>
                        <li>Setelah proses registrasi, admin akan mengiriman email konfirmasi mengenai kuitansi dan nomor keanggotaan</li>
                        <li>Aggota dapat mengecek kartu keanggotaan melalui link berikut <span class="fw-bold">https://dias.aptikom.org/login-anggota</span>menggunakan nomor anggota dan menginput password</li>                          
                        <li>Kartu anggota dapat di download di halaman utama</li>
                        <li>Jika sudah selesai, anggota dapat melakukan pengecekan keanggotaan individu pada link berikut <span class="fw-bold">https://dias.aptikom.org/list-anggota.</span></li>
                      </ol>
                  <p class="card-text mt-3"><span class="fw-bold">Prosedur pendaftaran PROGRAM STUDI :</span></p>
                      <ol>
                        <li>Silahkan lakukan registrasi pada link berikut <span class="fw-bold">https://dias.aptikom.org/prodi/pendaftaran</span></li>
                        <li>Setelah proses registrasi, admin akan mengiriman email konfirmasi mengenai kuitansi dan nomor keanggotaan</li>
                        <li>Aggota dapat mengecek kartu keanggotaan melalui link berikut <span class="fw-bold">https://dias.aptikom.org/login-anggota-prodi</span>menggunakan nomor anggota dan menginput password</li>                          
                        <li>Kartu anggota dapat di download di halaman utama</li>
                        <li>Jika sudah selesai, anggota dapat melakukan pengecekan keanggotaan individu pada link berikut <span class="fw-bold">https://dias.aptikom.org/list-anggota-prodi.</span></li>
                      </ol>
                  <p class="card-text mt-3"><span class="fw-bold">Prosedur perpanjangan PROGRAM STUDI :</span></p>
                      <ol>
                        <li>Silahkan lakukan registrasi pada link berikut <span class="fw-bold">https://dias.aptikom.org/prodi/pendaftaran</span></li>
                        <li>Setelah proses registrasi, admin akan mengiriman email konfirmasi mengenai kuitansi dan nomor keanggotaan</li>
                        <li>Aggota dapat mengecek kartu keanggotaan melalui link berikut <span class="fw-bold">https://dias.aptikom.org/login-anggota-prodi</span>menggunakan nomor anggota dan menginput password</li>                          
                  ...
                  <p class="card-text mt-3"><span class="fw-bold">Biaya Iuran Keanggotaan APTIKOM per Tahun :</span></p>
                      <ol>
                        <li>Individu/Perorangan *(BARU) Rp. 250,000,- (Dua Ratus Lima Puluh Ribu Rupiah).</li>
                        <li>Individu/Perorangan *(PERPANJANGAN) Rp. 150,000,- (Seratus Lima Puluh Ribu Rupiah)</li>
                        <li>Program Studi *(BARU) Rp. 750,000,- (Tujuh Ratus Lima Puluh Ribu Rupiah).</li>                          
                        <li>Program Studi *(PERPANJANGAN) Rp. 500,000,- (Lima Ratus Ribu Rupiah).</li>
                      </ol>
                  <p class="card-text mt-3"><span class="fw-bold">Nomor Rek. APTIKOM :</span></p>   
                  <p class="card-text mt-3">Bank BNI 46 cabang Perintis Kemerdekaan 1119995552.</p>  
                  <a href="{{ url('https://dias.aptikom.org/individu/pendaftaran')}}" class="btn btn-warning mt-3">Pendaftaran Keanggotaan Individu Baru</a> 
                  <p class="card-text mt-3">Info Lebih lanjut Hub :</p>  
                  <p class="card-text mt-3">sdri. Kannisa - 082118476100</p>  
                </div>
              </div>
          ...
          <div class=" col-md-5" data-aos="fade-up" data-aos-delay="100">
            <div class="">
                <a href="{{ url('https://dias.aptikom.org/individu/pendaftaran')}}" class="btn btn-warning mt-3">Pendaftaran Keanggotaan Individu Baru</a>
                <a href="{{ url('https://dias.aptikom.org/individu/perpanjangan')}}" class="btn btn-warning mt-3 mb-5">Perpanjangan Keanggotaan Individu</a>
                <a href="{{ url('https://dias.aptikom.org/prodi/pendaftaran')}}" class="btn btn-warning mt-5">Pendaftaran Keanggotaan Prodi Baru</a>
                <a href="{{ url('https://dias.aptikom.org/prodi/perpanjangan')}}" class="btn btn-warning mt-3">Perpanjangan Keanggotaan Prodi</a>
