      ...
      <div class="container position-relative d-flex align-items-center justify-content-between">
        <a href="{{ url('/')}}" class="logo d-flex align-items-center">
          ...
          <ul>
            ...
            <li class="dropdown"><a href="#"class="active"><span>TUPOKSI</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
              <ul>
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-xl-12 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="card">
                <div class="card-body">
                  <img src="assets/img/Tupoksi/Kesekretariatan/sekretariat.png" alt="" class="d-block mx-auto img-fluid" style="height: 500px">
                  <h5 class="mt-3">Koordinator :</h5>
                  <h5>Anggota :</h5>
                  <h5>Wewenang :</h5>
